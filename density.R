...
###图1
test <- read.csv("C:/Users/Lenovo/Desktop/Bioinformatics-master/plot/density/S3_presion.csv")
...
###保存图片
pdf("C:/Users/Lenovo/Desktop/Bioinformatics-master/plot/density/density16.pdf",width=4,height=8)### 保存图片
vplayout <- function(x,y){viewport(layout.pos.row = x, layout.pos.col = y)}
grid.newpage()  ###新建图表版面
pushViewport(viewport(layout = grid.layout(2,1)))
print(p1, vp = vplayout(1,1)) ###将(2,1)的位置画图p1
